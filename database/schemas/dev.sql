...
CREATE TABLE contacts (
  ...
  city_id INTEGER NULL DEFAULT NULL,  -- ref
  employer_id INTEGER NULL DEFAULT NULL,  -- ref
  spouse_id INTEGER NULL DEFAULT NULL, -- ref
  ...
  photo_id INTEGER NULL DEFAULT NULL,  -- ref
  business_card_id INTEGER NULL DEFAULT NULL,  -- ref
...
CREATE TABLE contact_groups (
  ...
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  contacts_id VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE interactions (
  ...
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  contacts_id VARCHAR(255) NULL DEFAULT NULL,
  interaction_type_id VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE notes (
  ...
  interactions_id INTEGER NULL DEFAULT NULL,
  PRIMARY KEY (id)
)
...
CREATE TABLE photos (
  ...
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  type VARCHAR(255),
  description_id TEXT NULL DEFAULT NULL,
